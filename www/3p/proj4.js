!function(e){
	...
	else {var f;"undefined"!=typeof window?f=window:"undefined"!=typeof global?f=global:"undefined"!=typeof self&&(f=self),f.proj4=e()}
}(
	function(){
		var define,module,exports;
		return (
			function e(t,n,r){ //t: dict with modules!, n: dict, r: array of module num
				function s(o,u){ //o: module num,
					if(!n[o]){if(!t[o]){ //A: no esta preloaded
...
module.exports = function(destination, source) {
	logm && logm("DBG",7,"proj4 EXPORTS",{destination: toJs(destination), source: toJs(source)});
	try {
  ...
  return destination;
	...
	catch (ex) { logmex && logmex("ERR",1,"proj4 EXPORTS",{destination: destination, source: source},ex); }
};
